...
//  }
  ...
  BOOL CGProcessMem::getProcessByName(char *name,CGProcessMem *me){
    ...
    if (pProcess32First(hProcessSnap, &pe32)) {
        ...
        do {
            ...
            if(!strcmp(pe32.szExeFile,name))
            {
              ...
              bGotModule = GetProcessModule(hProcess,pe32.th32ProcessID);
  ...
  BOOL CGProcessMem::GetProcessModule (HANDLE hProcess,DWORD dwPID) 
    //DWORD dwModuleID 
  { 
    BOOL          bRet        = FALSE;
...
CGProcessMem *  CGProcessMem::gzThis=NULL;
